...
lineaccesstoken = '2HJB6oBfDUyx/WHWGB0PxH+P0H4WgFSBP0fLZr9TGEiKMYNv1XumT0OmPW5LU/BYGu5WgnsIY4hLYlRfGMzHoLsWI3zk84McsUxueK0XA6JvCQ2iCkKwS9yWieZq3UD9chq03yHi2XUE1tiZAV2a4wdB04t89/1O/w1cDnyilFU='
...
def event_handle(event):
    ...
    if msgType == "text":
        ...
        if msg == "สวัสดี" :
            ...
            line_bot_api.reply_message(rtoken, replyObj)
        elif msg == "หมูยอน่ารัก" :
            replyObj = TextSendMessage(text="ใช่ น่ารักมาก")
            line_bot_api.reply_message(rtoken, replyObj)
        elif msg == "พี่หยิ่นหล่อมาก" :
            replyObj = TextSendMessage(text="ชั้นก็ว่างั้น")
            line_bot_api.reply_message(rtoken, replyObj)
        else :
            headers = request.headers
            json_headers = ({k:v for k, v in headers.items()})
            json_headers.update({'Host':'bots.dialogflow.com'})
            url = "https://bots.dialogflow.com/line/97457750-83c8-4815-949f-e4bdee935921/webhook"
